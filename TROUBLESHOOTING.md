# LunarX Home 3.1.2 troubleshooting
...
For an existing installation, 3.1.2 attempts automatic rollback to the timestamped pre-update application/config snapshot. If the installer reports that rollback also failed, do not delete persistent data. Keep the backup and follow `ROLLBACK_GUIDE.md`.
